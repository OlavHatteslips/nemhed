...
class ContentComponent extends React.Component{
	...
	makeTextFile(text) {
		...
		var file = new File([xml_serializer.serializeToString(doc)], "dinhjemmeside.html", {type: "text/plain;charset=utf-8"});
		saveAs(file);	
	};
	...
	createHtmlDoc(html){
			...
			css_bootstrap_stylesheet.setAttribute("type", "text/css");
			css_bootstrap_stylesheet.setAttribute("media", "screen");
			...
			css_stylesheet.setAttribute("type", "text/css");
			css_stylesheet.setAttribute("media", "screen");
